...
export default function AdminProductUpdate() {
  ...
  const getSingleProductData = async () => {
    try {
      const response = await fetch(`${API}/api/admin/products/${params._id}`, {
        method: "GET",
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API}/api/admin/products/update/${params._id}`,
        {
          method: "PATCH",
          headers: {
